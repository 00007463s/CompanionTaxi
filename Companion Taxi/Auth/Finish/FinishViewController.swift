...
class FinishViewController: UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    override func viewDidLoad() {
        ...
        tableView.register(FinishCell.self, forCellReuseIdentifier: "FinishCell")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       guard let cell = tableView.dequeueReusableCell(withIdentifier: "FinishCell", for: indexPath) as? FinishCell else { return UITableViewCell() }
